...
/**
 * Global variables - declared extern in the wineing.h.
 * These are shared among multiple files, namely
 * - wineing.cc
 * - tape_processor.win.cc
 */
w_ctrl g_data = {
 ...
 */
// static chan *g_market_thread_mchan;
...
//       chan_send(g_market_thread_mchan, buffer, m.ByteSize(), _send_free);
//       break;

//     // case NxMSG_EXGQUOTE:
//     //   m.set_type(MarketData::QUOTE_EX);
//     //   chan_send(g_market_thread_mchan, buffer, m.ByteSize(), NULL);
//     //   break;
