...
public class TestWineingWorks extends TestCase
{
    ...
    private static void withDefaultServer(Client c, Action a)
    {
        ...
        withServer(c, a, DEFAULT_CCHAN, DEFAULT_MCHAN,
                DEFAULT_TAPE_ROOT);
    }
    ...
    private static class Client
    {
        ...
        public Client(String cchan, String mchan)
        {
            ...
            BlockingQueue<Request> queue = new ArrayBlockingQueue<Request>(
                    1);
